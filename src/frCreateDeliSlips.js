...
//   try {
//     const fS = AppConfig.FREEE_SHEET_SETTINGS;
//     const lastRow = getLastDataRow(freeeSheet, fS.deliDateCol);
//     const values = freeeSheet.getRange(fS.contStartRow, 1, lastRow - fS.contStartRow + 1, freeeSheet.getLastColumn()).getValues();
...
//     return values;
//   } catch (error) {
//     throw new Error(`Error in getFreeeStValues: \n${error.message}`)
//   }
...
//   try {
//     const pS = AppConfig.PARTNER_SHEET_SETTINGS;
//     const fS = AppConfig.FREEE_SHEET_SETTINGS;
...
//         successOrders.push({ rowNum: req.rowNum, orderId });
//       } else {
...
//     const match = String(dateString || '').match(pattern);
//     const year = match[1];
